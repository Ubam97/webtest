            ...
            steps {
                script {
                    sshagent (credentials: ['argoCD']) {
                        ...
                        sh "ssh -o StrictHostKeyChecking=no ubuntu@3.34.127.63 argocd app create test --repo https://github.com/eub456/webtest.git --sync-option ApplyOutOfSyncOnly=true --path templates --dest-server https://kubernetes.default.svc --dest-namespace default"
                    }
                }
            }
        }
